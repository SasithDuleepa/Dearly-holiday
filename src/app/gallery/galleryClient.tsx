...
import Reel from "../../../public/images/1.png";
...
export default function GalleryPage({ allImages }: { allImages: ImagesByCategory }) {
  ...
  const limit = 9;
  const totalPages = useMemo(() => Math.ceil(currentImages.length / limit), [currentImages]);
