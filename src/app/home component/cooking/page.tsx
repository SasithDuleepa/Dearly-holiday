...
export default function HomeCooking() {
  return (
    <div className="text-center my-20">
      ...
      <div className="flex align-top content-between w-[100%] gap-20">
        <div className="w-[40%]">
        ...
        from spicy curries to crispy hoppers. Cook, taste, and laugh together in a warm, home-style kitchen.
      </p>

      <Link href="/cooking-class">Explore More</Link>
        </div>
